...
<body>
    ...
    <div class="py-md-5">
            <div class="container">
                ...
                <button type="button" name="choosemode" onclick="javascript:location.href='search.php'" class="btn btn-secondary">關鍵字搜尋</button>
                <button type="button" name="choosemode" onclick="javascript:location.href='search.php?choosemode=area'"  class="btn btn-secondary">地區搜尋</button>.
                </div>
                        ...
                        <select name="region_id" >
                            <option value="" selected= selected  disabled="true"required class="form-control">請選擇地區</option>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="form-group"><th>搜尋準度</th>                     
                                        <td>
