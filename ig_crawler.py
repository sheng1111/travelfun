# -*- coding: utf-8 -*-
"""
Created on Mon May  3 00:27:25 2021
...
chrome = webdriver.Chrome('C:\\Users\ysl58\Desktop/chromedriver', chrome_options=options)
...
def link_database(view,code,time,tag):
    ...
    # 連接 MySQL/MariaDB 資料庫
        ...
        # 顯示資料庫版本
            ...
            sql = "INSERT INTO `sight` (`view_id`, `view_name`, `shortcode`,`timestamp`, `tag_area`) VALUES (" + "'" + str(view_id) + "'" + "," + "'" + view_name + "'" + "," + "'" + shortcode +"'"  +  "," + "'" + timestamp +"'" + "," + "'" + tag_area +"'" +  ");"
            cursor = connection.cursor()
            cursor.execute(sql)
            connection.commit()
            sql = "SELECT * FROM `sight`"
...
parseig_location()
chrome.quit()
#update_data("taipei","D:\git\ig/taipei  2020_12_17_23_26_00.txt")