      ...
      for($i=0; $i<count($_FILES["up_photo"]); $i++) {
        if($_FILES["up_photo"]["tmp_name"][$i]!="") {
          ...
          if(move_uploaded_file($_FILES["up_photo"]["tmp_name"][$i], "photos/".$desc_file_name)) {
            $sql2 = "INSERT INTO photo2(sights_id, photo_file)";
            $sql2 .= " VALUES('$sights_id', '$desc_file_name')";
...
<body>
    ...
    <main>
      <div class="py-md-5">
            <div class="container">
          <form class="text-center p-5 col-md-6 offset-md-3" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
        ...
        <hr>
        <center>
          相片1 ：<input name="up_photo[]" type="file" class="form-control mb-4"><br>
          相片2 ：<input name="up_photo[]" type="file" class="form-control mb-4"><br>
          相片3 ：<input name="up_photo[]" type="file" class="form-control mb-4"><br>
          相片4 ：<input name="up_photo[]" type="file" class="form-control mb-4"><br>
          相片5 ：<input name="up_photo[]" type="file" class="form-control mb-4"><br>
        </center>
        <p align="center">
